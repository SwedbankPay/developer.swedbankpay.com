...
As the Mobile SDK is built on top of [Digital Payments][checkout]. It is a good idea
...
a working Digital Payments example with web technologies to use the Mobile SDK.
