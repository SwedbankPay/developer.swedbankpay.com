...
Speaking of [Digital Payments][digital-payments], we've cleaned that up as well,
and hope it will make things easier for you. The
...
A new [terminal section][payment-terminal] has been added. Exciting things are
...
Digital Payments offering, so our Starter and Business implementations are no
more. This means that we can do what we do best: giving you a payment experience
packed with options. The [Payments Only][digital-payments-payments-only]
...
[Enterprise][digital-payments-enterprise] is still available too.
...
smaller fixes and a [Digital Payments matrix][digital-payments-matrix] giving
you a better overview over which payment instruments v3 has to offer, and the
...
Another small one. We've added `paid` responses for all instruments in
...
[siteID][digital-payments-payments-only-redirect-request] field to Digital
Paymentsimplementations, re-worked nearly all
[headers][digital-payments-payments-only-seamless] across the portal to make
...
[3ds2-test]: /digital-payments/resources/test-data#otp-3ds2
[afd-payments]: /digital-payments/features/optional/afd
[age-restrictions]: /digital-payments/features/optional/age-restrictions
[android-configuration]: /digital-payments/modules-sdks/mobile-sdk/configuration#android
[android-sdk-documentation]: /digital-payments/modules-sdks/mobile-sdk/android
[apple-pay]: /digital-payments/payment-presentations#apple-pay
[authorization-timeouts]: /old-implementations/checkout-v2/capture
[callback]: /digital-payments/features/core/callback
...
[checkout-create-starter-paymentorder]: /digital-payments/enterprise/seamless-view#step-1-create-payment-order
...
[digital-payments-matrix]: /digital-payments
[digital-payments-enterprise]: /digital-payments/enterprise
[digital-payments-payments-only]: /digital-payments
[digital-payments]: /digital-payments
[digital-payments-payments-only-redirect-request]: /digital-payments/payment-request
[digital-payments-payments-only-seamless]: /digital-payments/display-payment-ui/seamless-view
...
[cross-channel-payments]: /digital-payments/features/optional/cross-channel-payments
[data-protection]: /digital-payments/resources/data-protection
[delete-payment-tokens]: /digital-payments/features/optional/delete-token#delete-paymenttoken-request
[demoshop]: https://ecom.externalintegration.payex.com/pspdemoshop
[design-guide]: https://design.swedbankpay.com/
[display-ui]: /digital-payments/display-payment-ui/
[eligibility-check]: /digital-payments/features/optional/instrument-mode#eligibility-check
[mac]: /old-implementations/checkout-v2/features/optional/mac
[features]: /digital-payments/features
[frictionless-payments]: /digital-payments/features/core/frictionless-payments
[frontpage]: https://developer.swedbankpay.com/
[fundamental-principles]: /digital-payments/resources/fundamental-principles
[get-started]: /digital-payments/
[google-pay]: /digital-payments/payment-presentations#google-pay
[home-technical-information]: /digital-payments/resources/fundamental-principles
...
[ios-configuration]: /digital-payments/modules-sdks/mobile-sdk/configuration#ios
[ios-sdk-documentation]: /digital-payments/modules-sdks/mobile-sdk/ios
...
[modules-sdks]: /digital-payments/modules-sdks
...
[payment-order-update]: /digital-payments/features/core/update
[payment-request]: /digital-payments/payment-request
...
[payer-aware-payment-menu]: /digital-payments/features/optional/payer-aware-payment-menu
[payout]: /digital-payments/features/optional/payout
[partners]: /digital-payments/resources/partners
[pax-net-sdk]: https://developer.stage.swedbankpay.com/payment-terminal/NET/
...
[recur]: /digital-payments/features/optional/recur
[resource-model-cancelled]: /digital-payments/features/technical-reference/resource-sub-models#cancelled
[resource-model-paid]: /digital-payments/features/technical-reference/resource-sub-models#paid
[resource-model-paid-swish]: /digital-payments/features/technical-reference/resource-sub-models#swish-paid-resource
[resource-model-payer]: /digital-payments/features/technical-reference/resource-sub-models#payer
...
[split-settlement]: /digital-payments/features/optional/split-settlement
[ssn-restrictions]: /digital-payments/features/optional/payer-restrictions
[status-models]: /digital-payments/features/technical-reference/status-models
[status-model-paid]: /digital-payments/features/technical-reference/status-models#paid
[status-model-paid-v2]: /old-implementations/checkout-v2/features/technical-reference/status-models#paid
[storing-uri]: /digital-payments/resources/fundamental-principles#storing-urls
...
[seamless-view-events]: /digital-payments/features/technical-reference/seamless-view-events
[seamless-view-events-onaborted]: /digital-payments/features/technical-reference/seamless-view-events#onaborted
...
[terminology]: /digital-payments/resources/terminology
[test-data]: /digital-payments/resources/test-data
[tos-url]: /digital-payments/features/optional/tos
...
[unscheduled-mit]: /digital-payments/features/optional/unscheduled
[v3-setup]: /digital-payments/setup
