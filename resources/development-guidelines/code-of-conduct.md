...
this, a `CODE_OF_CONDUCT.md` file from [Contributor Covenant][concov] should be
added to the project.

The Code of Conduct should be referenced from the `CONTRIBUTING` file, for
example with the following paragraphs:
