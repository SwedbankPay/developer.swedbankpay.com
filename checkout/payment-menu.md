...
this, depending on wether the payer is logged in (top) or a guest user (bottom):

{:.text-center}
![Payment Menu with payer logged in and card payment opened][login-payment-menu-image]{:width="450" height="900"}

{:.text-center}
![Payment Menu with guest payer and card payment opened][anon-payment-menu-image]{:width="450" height="850"}
...
[anon-payment-menu-image]: /assets/img/checkout/Newpaymentmenu450x850.png
...
[login-payment-menu-image]: /assets/img/checkout/LoggedInPaymentMenu450x900.png
