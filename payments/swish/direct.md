...
| {% icon check %} | └➔&nbsp;`language`           | `string`      | {% include field-description-language.md documentation_section="swish" %}                                                                                                                                                                                                                                                                       |
...
| └➔&nbsp;`language`       | `string`     | {% include field-description-language.md documentation_section="swish" %}                                                                                                                                                                                                                                                                                                                             |
