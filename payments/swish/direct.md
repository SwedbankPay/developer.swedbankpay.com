...
| &nbsp;`sale`                   | `string`      | The operation that the `payment` is supposed to perform. The `sale` transaction is used in our example.                                                                                                                                                                                                                                                 |
| └➔&nbsp;`date`                      | `string`      | This value is depricated. Do NOT use this in your integration.                                                                                                                                                                                                                                                                                                                                               |
| └➔&nbsp;`paymentRequestToken`                    | `string`      | ?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| └➔&nbsp;`id`                      | `object`      | The relative URI of the current `sale` resource.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| └➔&nbsp;`transaction`                       | `string`      | The `transaction` object contains information about the specific transaction. |
| └─➔&nbsp;`id`                     | `string`     | The relative URI of the current `transaction` resource..                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| └─➔&nbsp;`created`                  | `integer`     | The ISO-8601 date and time of when the transaction was created.                                                                                                                                                                                                                                                                                                                                                                                                                        |
| └─➔&nbsp;`updated`                 | `string(40)`  | The ISO-8601 date and time of when the transaction was created.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| └─➔&nbsp;`type`              | `string`      | Indicates the transaction type.                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| └─➔&nbsp;`state`        | `string`     | The current status of this transaction. The status `AwaitingActivity`, meansm that we are awaiting a response from Swish.                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| └─➔&nbsp;`number`                   | `integer`      | The transaction `number`, useful when there's need to reference the transaction in human communication. Not usable for programmatic identification of the transaction, for that `id` should be used instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| └─➔&nbsp;`amount`                    | `integer`      | Amount Entered in the lowest momentary units of the selected currency. E.g. 10000 = 100.00 SEK, 5000 = 50.00 SEK.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| └─➔&nbsp;`vatAmount`                        | `integer`      | Amount Entered in the lowest momentary units of the selected currency. E.g. 10000 = 100.00 SEK, 5000 = 50.00 SEK.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| └─➔&nbsp;`description`                | `string(40)`      | A human readable description of maximum 40 characters of the transaction.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
