...
|        | creditCard.no3DSecure                                | boolean     | `true` if 3DSecure are to be disabled for this payment; otherwise `false` per default. To use this feature it has to be enabled on the contract with Swedbank Pay.                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|        | creditCard.noCvc                                     | boolean     | `true` if the CVC field can be disabled for this payment; otherwise `false` per default. To use this feature it has to be enabled on the contract with Swedbank Pay.                                                                                                                                                                                                                                                                                                                                                                                                                                              |
