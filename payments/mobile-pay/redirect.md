...
| {% icon check %} | └➔&nbsp;`description`           | `string(40)` | {% include field-description-description.md payment_instrument="mobile-pay" %}                                                                                                                                                                                                  |
...
| {% icon check %} | └➔&nbsp;`language`              | `string`     | {% include field-description-language.md payment_instrument="mobile-pay" %}                                                                                                                                                                                                                               |
...
| └➔&nbsp;`language`       | `string`     | {% include field-description-language.md payment_instrument="mobile-pay" %}                                                                                                                                                                                                                                                                                                                             |
