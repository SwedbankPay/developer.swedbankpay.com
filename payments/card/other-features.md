...
| └➔&nbsp;`riskIndicator`               | `string` | This object consist of information that helps verifying the payer. Providing these fields decreases the likelihood of having to promt for [3-D Secure authentication][3ds2] of the payer when they are authenticating the purchase.                                                                                                                                                                                                                                                                                                                              |
