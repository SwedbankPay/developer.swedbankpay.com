...
|  ✔︎︎︎︎︎  | └─➔&nbsp;`vatAmount`                     | `integer`     | If the amount given includes VAT, this may be displayed for the user in the payment (redirect only). Set to 0 (zero) if this is not relevant.                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
* The service is available both through hosted payments and through direct
  API integration.
