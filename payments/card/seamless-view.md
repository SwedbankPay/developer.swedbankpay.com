...
![screenshot of the hosted view card payments][hosted-view-card]{:height="250px" width="660px"}
...
|  ✔︎︎︎︎︎  | └─➔&nbsp;`vatAmount`                  | `integer`     | If the amount given includes VAT, this may be displayed for the user in the payments(redirect only). Set to 0 (zero) if this is not relevant.                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
|  ✔︎︎︎︎︎  | └─➔&nbsp;`completeUrl`                | `string`      | The URL that Swedbank Pay will redirect back to when the payment is completed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
|          | └─➔&nbsp;`termsOfServiceUrl`          | `string`      | A URL that contains your terms and conditions for the payment, to be linked on the payment. Require https.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
