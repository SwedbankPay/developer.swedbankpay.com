...
For general information about problem messages and error handling,[visit error handling and problem details.][error-handling-and-problem-details]
...
{:.table .table-striped}
| **Type** | **Status** |
| VIPPS\_DECLINED | 400 | Any status that is not YES |
...
{:.table .table-striped}
| **Type** | **Status** |
| CARD\_BLACKLISTED | 400 |
| PAYMENT\_TOKEN\_ERROR | 403 |
| CARD\_DECLINED | 403 |
| ACQUIRER\_ERROR | 403 |
| ACQUIRER\_CARD\_BLACKLISTED | 403 |
| ACQUIRER\_CARD\_EXPIRED | 403 |
| ACQUIRER\_CARD\_STOLEN | 403 |
| ACQUIRER\_INSUFFICIENT\_FUNDS | 403 |
| ACQUIRER\_INVALID\_AMOUNT | 403 |
| ACQUIRER\_POSSIBLE\_FRAUD | 403 |
| FRAUD\_DETECTED | 403 |
| BAD\_REQUEST | 500 |
| INTERNAL\_SERVER\_ERROR | 500 |
| BAD\_GATEWAY | 502 |
| ACQUIRER\_GATEWAY\_ERROR | 502 |
| ACQUIRER\_GATEWAY\_TIMEOUT | 504 |
| UNKNOWN\_ERROR | 500 |

 

*   [Payment Resource](#HPaymentResource)
*   [Create Payment](#HCreatePayment)
*   [Purchase](#HPurchase)
*   [Operations](#HOperations)
*   [Vipps transactions](#HVippstransactions)
*   [Authorizations](#HAuthorizations)
*   [Captures](#HCaptures)
*   [Create capture transaction](#HCreatecapturetransaction)
*   [Cancellations](#HCancellations)
*   [Create cancellation transaction](#HCreatecancellationtransaction)
*   [Reversals](#HReversals)
*   [Create reversal transaction](#HCreatereversaltransaction)
*   [Callback](#HCallback)
*   [Problem messages](#HProblemmessages)
*   [Error types from Vipps (Init-call)](#HErrortypesfromVipps(Init-call))
*   [Error types from Vipps (Callback)](#HErrortypesfromVipps(Callback))
*   [Error types from Acquirer](#HErrortypesfromAcquirer)
