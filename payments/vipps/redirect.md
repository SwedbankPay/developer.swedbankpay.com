...
| {% icon check %} | └➔&nbsp;`language`         | `string`      | {% include field-description-language.md documentation_section="vipps" %}                                                                                                                                                                                                                                                                                              |
...
| └➔&nbsp;`language`       | `string`     | {% include field-description-language.md documentation_section="vipps" %}                                                                                                                                                                                                                                                                                                                             |
