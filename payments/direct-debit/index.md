...
Swedbank Pay to make a purchase. The links will take you directly to the API 
...
sequenceDiagram
  Participant PayEx
  Merchant->>PayEx: POST [direct debit reversals]
  Activate Merchant
  Activate PayEx
...
[core payment resources][direct-debit-technical-reference] section.
