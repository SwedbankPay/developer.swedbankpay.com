...
Within the invoice payments part of the eCommerce API, you can create one kind
of invoice, and you can inspect and alter the details of the individual
transactions within the payment.
