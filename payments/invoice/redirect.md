...
|                  | └─➔&nbsp;`paymentUrl`             | `string`      | This Parameter is used when the consumer is redirected out of the Seamless View (the iframe) and sent back after completing the payment. It should point to the page of where the Payment Order Seamless View is hosted. Read more about paymentUrl [here](https://developer.swedbankpay.com/checkout/other-features#payment-url-1).                                                          |
