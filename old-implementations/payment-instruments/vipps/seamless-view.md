...
| {% icon check %} | {% f intent %}                  | `string`      | `Authorization`. Reserves the amount, and is followed by a [cancellation](/old-implementations/payment-instruments/vipps/features/core/cancel) or [capture](/old-implementations/payment-instruments/vipps/capture) of funds.                                                          |
