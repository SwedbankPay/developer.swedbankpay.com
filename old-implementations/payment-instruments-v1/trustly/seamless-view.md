...
| {% icon check %} | {% f language %}           | `enum(string)`      | {% include fields/language.md api_resource="trustly" %}                                                                                                                                                                                                                                 |
...
[payment-resource]: /old-implementations/payment-instruments-v1/trustly/technical-reference/payment-resource
