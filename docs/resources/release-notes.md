...
[apple-pay]: /paymetnmenu/payment-presentations#apple-pay
[authorization-timeouts]: /checkout-v2/capture
[callback]: /paymetnmenu/payments-only/features/core/callback
...
[checkout-create-starter-paymentorder]: /paymetnmenu/enterprise/seamless-view#step-1-create-payment-order
...
[pay-matrix]: /paymetnmenu/#choose-the-right-implementation-for-your-business
[pay-enterprise]: /paymetnmenu/enterprise
[pay-payments-only]: /paymetnmenu/payments-only
[pay-payments-only-redirect-request]: /paymetnmenu/payments-only/redirect#payment-order-request
[pay-payments-only-seamless]: /paymetnmenu/payments-only/seamless-view
[click-to-pay]: /paymetnmenu/payment-presentations#click-to-pay
...
[eligibility-check]: /paymetnmenu/payments-only/features/optional/instrument-mode#eligibility-check
[mac]: /checkout-v2/features/optional/mac
[frontpage]: https://developer.swedbankpay.com/
[get-started]: /paymetnmenu/
[gift-cards]: /gift-cards
[google-pay]: /paymetnmenu/payment-presentations#google-pay
...
[payment-order-update]: /paymetnmenu/business/features/optional/update
...
[payer-aware-payment-menu]: /paymetnmenu/payments-only/features/optional/payer-aware-payment-menu
[prices]: /checkout-v2/features/technical-reference/prices
[update-order-checkout]: /checkout-v2/features/optional/update
[recur]: /paymetnmenu/payments-only/features/optional/recur
[resource-model-cancelled]: /paymetnmenu/payments-only/features/technical-reference/resource-sub-models#cancelled
[resource-model-paid]: /paymetnmenu/payments-only/features/technical-reference/resource-sub-models#paid
[resource-model-paid-swish]: /paymetnmenu/payments-only/features/technical-reference/resource-sub-models#swish-paid-resource
...
[ssn-restrictions]: /paymetnmenu/payments-only/features/optional/payer-restrictions
[status-models]: /paymetnmenu/payments-only/features/technical-reference/status-models
[status-model-paid]: /paymetnmenu/payments-only/features/technical-reference/status-models#paid
...
[seamless-view-events]: /paymetnmenu/payments-only/features/technical-reference/seamless-view-events
[seamless-view-events-onaborted]: /paymetnmenu/starter/features/technical-reference/seamless-view-events#onaborted
[seamless-view-events-card]: /payment-instruments/card/features/technical-reference/seamless-view-events
[sequence-diagrams]: /paymetnmenu/sequence-diagrams
...
[unscheduled-mit]: /paymetnmenu/payments-only/features/optional/unscheduled
[v3-setup]: /paymetnmenu/payments-only/#step-1-sign-up-for-a-test-account
