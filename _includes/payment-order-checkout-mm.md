...
|                  | └─➔&nbsp;`payerReference`                     | `string`     | A reference used in Merchant Managed and Merchant Authenticated implementations to recognize the payer in the absence of SSN and/or a secure login.                                                                                                                                                                                                              |
