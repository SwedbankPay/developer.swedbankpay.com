...
| └➔&nbsp;`payerReference` | `string`     | The reference to the payer (consumer/end-user) from the merchant system, like e-mail address, mobile number, customer number etc. Used in [Merchant Identified Payer][merchant-identified-payer].                                                                                                                                                          |
