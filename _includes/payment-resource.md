...
| └➔&nbsp;`description`    | `string(40)` | {% include field-description-description.md payment_instrument=payment_instrument %}                                                                                                                                                                                                                                                                                            |
...
| └➔&nbsp;`language`       | `string`     | {% include field-description-language.md payment_instrument=payment_instrument %}                                                                                                                                                                                                                                                                                                                              |
