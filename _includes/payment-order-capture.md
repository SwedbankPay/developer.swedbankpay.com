...
|          | └─➔&nbsp;`description`         | `string(40)`     | The human readable description of maximum 40 characters of the order item.                                                                                                                                                                                                                                                                     |
...
|   ︎︎︎    | └─➔&nbsp;`imageUrl`            | `string`     | The URL to an image of the order item.                                                                                                                                                                                                                                                                                |
|   ︎︎︎    | └─➔&nbsp;`description`         | `string(40)`     | The human readable description of of maximum 40 characters of the order item.                                                                                                                                                                                                                                                                     |
