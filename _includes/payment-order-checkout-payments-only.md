...
|                  | └─➔&nbsp;`payerReference`                     | `string`     | A reference used in the Enterprise and Payments implementations to recognize the payer in the absence of SSN and/or a secure login. Read more about this in the [payerReference](/checkout-v3/payments-only/features/optional/enterprise-payer-reference) feature section.                                                                                                                                                                                                                                        |
...
| └➔&nbsp;`implementation`       | `string`     | The merchant's Checkout v3 implementation type. `Authenticated`, `Enterprise`, `PaymentsOnly` or `Starter`. We ask that you don't build logic around this field's response. It is mainly for information purposes, as the integration types might be subject to name changes. If this should happen, updated information will be available in this table.                                                                                                   |
