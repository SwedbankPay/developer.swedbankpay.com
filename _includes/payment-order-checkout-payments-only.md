...
| {% icon check %} | {% f instrument %}                 | `string`     | Only used for [Instrument Mode][instrument-mode]. Set the field to the payment instrument you wish to display. If no instrument is specified, the full payment menu will be displayed.                                                                                                                                                                                                                                                                           |
