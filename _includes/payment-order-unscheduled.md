...

{
    "paymentorder": {
        ...
        "language": "sv-SE",
        "generateUnscheduledToken": true, {% if documentation_section contains "digital-payments" %}
...
|                  | {% f generateUnscheduledToken %}| `boolean`     | `true` or `false`. Set to `true` if you want to generate an `unscheduledToken` for future unscheduled purchases (Merchant Initiated Transactions).       | {% if documentation_section contains "digital-payments" %}
...
| {% f availableInstruments %}       | `string`     | A list of instruments available for this payment.                                                                                                                                                   | {% if documentation_section contains "digital-payments" %}
