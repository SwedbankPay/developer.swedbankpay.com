...
| {% f availableInstruments %}       | `string`     | A list of payment methods available for this payment.                                                                                                                                                   | {% if documentation_section contains "checkout-v3" %}
...
| {% f payer %}         | `id`     | The URL to the [`payer` resource]({{ techref_url }}/technical-reference/resource-sub-models#payer) where information about the payer can be retrieved.                                                                                                                 | {% else %}
...
| {% f history %}     | `ic`     | The URL to the [`history` resource]({{ techref_url }}/technical-reference/resource-sub-models#history) where information about the payment's history can be retrieved.                                                                                                                            |
