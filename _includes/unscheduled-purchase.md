...
| {% icon check %} | {% f description %}             | `string(40)`  | {% include fields/description.md %}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | {% if documentation_section == "payment-menu" or documentation_section contains "checkout" %}
...
| {% f language %}                | `string`     | {% include fields/language.md %}                                                                                                                                                                                                                                                                                      | {% if documentation_section == "payment-menu" or documentation_section contains "checkout" %}
