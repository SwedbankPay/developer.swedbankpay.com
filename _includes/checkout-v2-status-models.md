        ...
        <div class="api-children">
          ...
          <details class="api-item" data-level="2">
            ...
            <div class="api-children">
              ...
              <details class="api-item" data-level="3">
                <summary>
                  <span class="field">{% f transactionInitatior, 2 %}<i aria-hidden="true" class="chev swepay-icon-plus-add small"></i></span>
                  <span class="type"><code>string</code></span>
                </summary>
...
<div class="api-compact" aria-label="Response">
  ...
  <details class="api-item" data-level="0">
    <summary>
      <span class="field">{% f tokens, 0 %}<i aria-hidden="true" class="chev swepay-icon-plus-add small"></i></span>
      <span class="type"><code>integer</code></span>
    </summary>
