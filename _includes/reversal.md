...
| {% f created, 2 %}        | `date(string)`  | The ISO 8601 date and time of when the transaction was created. Written in the format YYYY-MM-DDTHH:MM:SSZ, where Z indicates UTC.                                                                                                                                             |
| {% f updated, 2 %}        | `date(string)`  | The ISO 8601 date and time of when the transaction was updated. Written in the format YYYY-MM-DDTHH:MM:SSZ, where Z indicates UTC.                                                                                                                                             |
