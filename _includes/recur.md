...
| {% icon check %} | └─➔&nbsp;`userAgent`           | `string`     | The [`User-Agent` string](https://en.wikipedia.org/wiki/User_agent
) of the payer's web browser.                                                                                                                                                                                                                  |
...
| {% icon check %} | └─➔&nbsp;`subsite`             | `String(40)` | The subsite field can be used to perform [split settlement][/checkout/features/core/settlement-reconciliation#split-settlement] on the payment. The subsites must be resolved with Swedbank Pay [reconciliation](/checkout/features/core/settlement-reconciliation) before being used.                                                                      |
