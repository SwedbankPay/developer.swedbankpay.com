...

{
    "paymentorder": {
        ...
        "language": "sv-SE", {% if documentation_section contains "pay/payments-only" %}
        ...
        "payeeInfo": {
            ...
            "subsite": "MySubsite", {% if documentation_section contains "pay/payments-only" %}
...
| {% icon check %} | {% f language %}                 | `string`     | The language of the payer.                                                                                                                                                                                                                                                                               | {% if documentation_section contains "pay/payments-only" %}
...
|                  | {% f subsite, 2 %}                | `string(40)` | {% include fields/subsite.md %} | {% if documentation_section contains "pay/payments-only" %}
...

{
    "paymentorder": {
        ...
        "availableInstruments": [
          ...
          "Swish",
          "CreditAccount",
          "Trustly" ], {% if documentation_section contains "pay" %}
