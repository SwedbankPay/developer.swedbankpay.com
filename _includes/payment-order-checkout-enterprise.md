...
|                  | {% f paymentUrl, 2 %}              | `string`     | {% include fields/payment-url-paymentorder.md %} | {% endif %}
...
| {% f availableInstruments %}       | `string`     | A list of payment methods available for the payment.                                                                                                                                                   |
