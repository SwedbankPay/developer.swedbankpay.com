...

{
    "paymentorder": {
        ...
        "payer": {
            "id": "/psp/paymentorders/39b2bd9f-55ac-467d-d2ab-08d9a9a98bbe/payers"
        },
        "payments": {
...
| └➔&nbsp;`paymentToken`   | `string`     | The payment token created for the purchase used in the authorization to create [One Click Payments]({{ features_url }}/optional/one-click-payments).                                                                      |{% endif %}
