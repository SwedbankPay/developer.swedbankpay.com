...

{
    "paymentorder": {
        ...
        "payer": {  {% if documentation_section == "checkout" %}
...
|                  | └➔&nbsp;`payer`                   | `object`     | The `payer` object containing information about the payer relevant for the payment order.                                                                                                                                                                                                                | {% if documentation_section == "checkout" %}     |
