...
<div class="api-compact" role="table" aria-label="Request">
  ...
  <details class="api-item" role="rowgroup" data-level="0">
    ...
    <div class="api-children">
      ...
      <details class="api-item" role="rowgroup" data-level="1">
        <summary role="row">
          <span class="field" role="rowheader">{% f generateRecurrenceToken %}<span class="chev" aria-hidden="true">▸</span></span>
      ...
      <details class="api-item" role="rowgroup" data-level="1">
        ...
        <div class="api-children">
          ...
          <details class="api-item" role="rowgroup" data-level="2">
            <summary role="row">
              <span class="field" role="rowheader">{% f consumerProfileRef, 2 %}<span class="chev" aria-hidden="true">▸</span></span>
              <span class="type"><code>string</code></span>
              <span class="req"></span>
            </summary>
          ...
          <details class="api-item" role="rowgroup" data-level="2">
            <summary role="row">
              <span class="field" role="rowheader">{% f workPhoneNumber, 2 %}<span class="chev" aria-hidden="true">▸</span></span>
              <span class="type"><code>string</code></span>
              <span class="req"></span>
            </summary>
          ...
          <details class="api-item" role="rowgroup" data-level="2">
            <summary role="row">
              <span class="field" role="rowheader">{% f homePhoneNumber, 2 %}<span class="chev" aria-hidden="true">▸</span></span>
              <span class="type"><code>string</code></span>
              <span class="req"></span>
            </summary>
