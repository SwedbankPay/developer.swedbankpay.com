...

{
  ...
  "payer": {
    ...
    "msisdn": "+46722345678",  {% unless documentation_section contains "digital-payments/payments-only" %}
    "gender": "male",
    "birthYear": "1980", {% endunless %}
    "hashedFields": {
      "emailHash": "968e23eda8818f8647d15775c939b3bc32ba592e",
      "msisdnHash": "a23ec9d5b9def87cae2769cfffb0b8a0487a5afd"  {% unless documentation_section contains "digital-payments/payments-only" %},
...
| {% f msisdn %}        | `string`     | The msisdn of the payer.       | {% unless documentation_section contains "digital-payments/payments-only" %}
...
| {% f msisdnHash %}              | `string`   | A hashed version of the payer's email. |  {% unless documentation_section contains "digital-payments/payments-only" %}
