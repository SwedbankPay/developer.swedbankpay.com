...
|  ✔︎︎︎︎︎  | └➔&nbsp;`description`          | `string(40)`     | A textual description of maximum 40 characters of why the transaction is reversed.                                                                                                                                                                                                                                                               |
...
|          | └─➔&nbsp;`description`         | `string(40)`     | A human readable description of maximum 40 characters of the order item.                                                                                                                                                                                                                                                                     |
