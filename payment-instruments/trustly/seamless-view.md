...
|                  | └─➔&nbsp;`logoUrl`           | `string`      | {% include fields/logo-url.md documentation_section="trustly" %}                                                                                                                                                                |
...
| {% icon check %} | └➔&nbsp;`payeeInfo`          | `object`      | {% include fields/payee-info.md documentation_section="trustly" %}                                                                                                                                                                                                                                              |
