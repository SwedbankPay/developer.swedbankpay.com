...
| {% icon check %} | └─➔&nbsp;`payerReference`                | `string`     | {% include field-description-payer-reference.md documentation_section="trustly" %}                                                                                                                                                                                                                                                           |
...
[completeurl]: /payment-instrument/trustly/other-features#completeurl
