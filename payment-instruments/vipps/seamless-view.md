...
| {% icon check %} | {% f intent %}                  | `string`      | `Authorization`. Reserves the amount, and is followed by a [cancellation](/payment-instruments/vipps/features/core/cancel) or [capture](/payment-instruments/vipps/capture) of funds.                                                          |
