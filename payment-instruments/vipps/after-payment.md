...
| {% icon check %}︎ | └─➔&nbsp;`vatAmount`         | `integer`    | {% include fields/vat-amount.md currency="NOK" %}                                                                                                                                                                                               |
...
| {% icon check %}︎ | └➔&nbsp;`payeeInfo`          | `object`     | {% include fields/payee-info.md %}                                                                                                                                                                                                        |
...
| {% icon check %} | └➔&nbsp;`vatAmount`      | `integer`    | {% include fields/vat-amount.md currency="NOK" %}                      |
