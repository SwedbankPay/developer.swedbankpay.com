...
Note over POS: Do not display message about verifying the signature. Do not let the cashier have the chance of refusing the transaction.
POS->>NetSDK: callback(true)
NetSDK->>-POS: PaymentRequestResult
Note over NetSDK: Success. Always print the customer receipt
```
